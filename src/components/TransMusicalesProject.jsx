...
import menuTrans from "../assets/img/menu-trans.png";
import artistesTrans from "../assets/img/artistes-trans.png";
import planningTrans from "../assets/img/planning-trans.png";
import playlistTrans from "../assets/img/playlist-trans.png";

const TransMusicalesProject = () => {
      ...
      <main className="flex-1 flex flex-col items-center p-4 mt-[10vh]">
          ...
          <div className="projet-text flex flex-col md:flex-row gap-6">
            <div className="projet-description flex-1 bg-white border-2 border-black rounded-lg p-4 shadow-md">
              <h2 className="text-xl font-semibold border-b-2 border-black pb-2 mb-4 text-gray-800">
                Description Projet 72h
              </h2>
              <p>
                Le projet 72h entre Ynov et Les Trans visait à attirer et captiver la génération Z lors de la prochaine
                édition du festival. Nous devions créer une maquette d'un site et/ou d'une application.
              </p>
            </div>
        ...
        <div className="return-home mt-8">
          <Link
            ...
            style={{
              backgroundImage: "linear-gradient(#A86500, #FFB342)",
            }}
          >
...
export default TransMusicalesProject;
